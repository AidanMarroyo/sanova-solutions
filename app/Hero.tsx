  ...
  return (
    <MaxWidthWrapper className='grid lg:grid-cols-12 lg:gap-8 xl:gap-0'>
      <div className='mr-auto place-self-center lg:col-span-7'>
        ...
        <h1 className='max-w-2xl text-4xl  leading-none tracking-tight text-white md:text-6xl'>
          WEB SOLUTIONS EMPOWERING BUSINESSES TO
        </h1>
        <WordRotate
          words={['SCALE', 'SUCCEED']}
          className='mb-4 max-w-2xl text-4xl  leading-none tracking-tight text-white md:text-6xl '
        />
